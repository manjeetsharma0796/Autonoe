...
const ASSISTANT_FOLLOWUPS = [
  "What is the live mUSD/WOKB depth right now?",
  "Summarize the risk on my agent wallet",
  "Which asset has the strongest 4h trend?",
  "Explain how the judge panel verdict works",
];
...
function ThesisPane() {
  const [intent, setIntent] = useState(
    "BTC is holding above its 50-bar average. Build a 4h swing thesis against mUSD.",
  );
...
const INITIAL_MESSAGES: ChatMessage[] = [
  {
    ...
    content:
      ...
      "## What I can do\n" +
      "- **Market reads**: price, depth, funding and 4h structure for WOKB, BTC, ETH, SUI, SOL\n" +
      "- **Wallet checks**: balances, exposure and risk on your agent wallet\n" +
      "- **Thesis to verdict**: turn an idea into a judge-panel verdict you can execute\n\n" +
