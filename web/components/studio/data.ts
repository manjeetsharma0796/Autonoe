...
export const DEFAULT_INTENT =
  "WOKB looks oversold after the testnet incentive cliff - is there a scaled long worth taking against mUSD?";

export const DEFAULT_HUMAN_CASE =
  "WOKB has round-tripped to its pre-incentive range while on-chain TVL held flat - sellers look exhausted. I'd scale a long against mUSD, sized small, adding only on a reclaim of the 1.30 level. Invalidation: a daily close back under 1.18.";
...
export const THESIS_TRACE: TraceStep[] = [
  {
    ...
    detail:
      "Net DEX inflow to WOKB positive over 72h; agent-wallet holders flat, not distributing. No abnormal contract approvals on the pair.",
  },
  {
    label: "subagent · market",
    detail:
      "mUSD/WOKB printed a higher low at 1.21 after the -7% incentive-cliff flush; 24h change +4.21%, volume reverting to the 14-day mean.",
  },
  {
