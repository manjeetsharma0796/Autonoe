...
const Extracted = z.object({
  ...
  asset: z
    .string()
    .nullish()
    .describe('the ticker symbol in uppercase, e.g. SOL, BTC, ETH, WOKB, SUI'),
  capital: z
    .string()
    .nullish()
...
const SYSTEM =
  ...
  'while scoping a crypto trade (assets vs the mUSD stablecoin: WOKB, BTC, ETH, SUI, SOL). ' +
  ...
  '- asset: the ticker symbol, uppercase (e.g. SOL, BTC, WOKB).\n' +
