...
const SYSTEM = [
  ...
  '(assets traded vs the mUSD stablecoin: WOKB, BTC, ETH, SUI, SOL).',
  '',
  ...
  '  ```chart',
  '  {"type":"bar","title":"4h momentum","unit":"%","data":[{"label":"WOKB","value":4.2},{"label":"BTC","value":-1.1}]}',
  '  ```',
  ...
  '(e.g. "BTC", "WOKB", "PEPE") - do not append USDT yourself.',
  '',
...
export const tickerTool = tool(
  ...
  {
    name: 'get_ticker',
    description: 'Fetch live Bybit spot price for any token symbol (e.g. BTC, WOKB, PEPE).',
